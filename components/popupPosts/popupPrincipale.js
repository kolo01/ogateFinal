...
export default function PrincipalePopup() {
  ...
  const [fields, setFields] = useState([
    { id: 1, fileType: "IMAGE", selectedFile: null },
  ]);
  ...
  const handleAddField = () => {
    ...
    setFields([
      ...fields,
      { id: newId, fileType: "IMAGE", selectedFile: null },
    ]);
  };
  ...
  const [checkedQ, setCheckedQ] = useState([]); //utiliser pour recuperer les info additionelles sur les biens cochés
  const [OtherQ, setOtherQ] = useState([]); //utiliser pour recuperer les info additionelles sur les biens cochés
  const [OtherB, setOtherB] = useState([]); //utiliser pour recuperer les info additionelles sur les biens cochés
  ...
  const handleSubmit = () => {
    console.log("typePoste", JSON.stringify(TypePoste));
    console.log("meuble", JSON.stringify(meuble));
    console.log("typeBien", JSON.stringify(parseInt(StypeBien)));
    console.log("typeDocument", JSON.stringify(checkedD));
   

    ///Deuxieme view
    console.log("NPieces", JSON.stringify(nbPiece));
    console.log("NChambre", JSON.stringify(nbChambre));
    console.log("NBain", JSON.stringify(parseInt(nbSbain)));
    console.log("NSalon", JSON.stringify(nbSalon));
    console.log("Prix", JSON.stringify(prix));
    console.log("Periodicite", JSON.stringify(periodicite));
    console.log("Apport", JSON.stringify(apportInit));

    ///troisieme view

    console.log("IAddBien", JSON.stringify(checkedB));
    console.log("OAddBien", JSON.stringify(OtherB));
    console.log("IAddQuart", JSON.stringify(checkedQ));
            ...
            <Box>
              ...
              {stepper < 4 ? (
                <Button
                  colorScheme="blue"
                  onClick={() => {
                    Next(stepper), setStepper(stepper + 1);
                  }}
                >
                  Suivant
                </Button>
            ...
            <Box>
              ...
              {stepper > 1 ? (
                <Button
                  variant="ghost"
                  onClick={() => {
                    Previous(stepper), setStepper(stepper - 1);
                  }}
                >
                  Revenir
                </Button>
